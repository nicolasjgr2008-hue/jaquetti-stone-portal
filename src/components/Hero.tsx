          ...
          <AnimatedSection delay={0.8} className="pt-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <MagneticButton>
                ...
                >
                  <a href="https://wa.me/55SEUNUMERO?text=Olá!%20Vim%20pelo%20site%20e%20quero%20iniciar%20meu%20projeto" target="_blank" rel="noopener noreferrer" className="flex items-center">
