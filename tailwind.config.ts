...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'marble-texture': "url('data:image/svg+xml,%3Csvg width=\"100\" height=\"100\" xmlns=\"http://www.w3.org/2000/svg\"...%3C/svg%3E')",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "text-glow": {
          ...
          "50%": { textShadow: "0 0 20px hsl(var(--primary) / 0.6), 0 0 30px hsl(var(--primary) / 0.3)" },
        },
        "border-dance": {
